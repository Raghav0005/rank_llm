...
MODEL_ID = "AQ-MedAI/Diver-GroupRank-7B"
...
DIVER_TEMPLATE_PATH = (
    "src/rank_llm/rerank/prompt_templates/pointwise_diver_template.yaml"
)
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-root",
        default="rerank_results/diver_pointwise",
    ...
    coordinator = PointwiseVLLM(
        ...
        prompt_template_path=DIVER_TEMPLATE_PATH,
        batch_size=args.batch_size,
        max_concurrent_llm_calls=args.max_concurrent,
        scoring_mode="json_doc_score_0_10",
